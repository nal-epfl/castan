...
typedef int st_compare_func(void*, void*);
typedef st_index_t st_hash_func(void*);
...
// Also commented out, see top of file
//#if defined(__cplusplus)
//#if 0
//{ /* satisfy cc-mode */
//#endif
